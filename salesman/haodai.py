...
def hd_applyNewLoan():
    ...
    data3 = {"loanInfoJsonStr": {"name": "程永", "idcard": "330722197011215918", "phone": "13536670555", "loanMoney": "99000", "loanLimit": 12, "empNo": "", "provinceId": 19,
               "cityId": 202, "gpsProvince": "", "gpsCity": "", "longitude": "114.03441325044989,65", "channelCode": "010"},
              "method": "applyNewLoan",
              "subtime": "1481092917560"}
    params = urllib.urlencode(data3)    #把整个body数据转为16进制
    print(params)
    res3 = requests.get(url3, params=params, cookies=login_cookies())
